...
public enum Commands {
	...
	// All enum names
	WG, WGHELP, WGSIGNUP, WGPOINTS, WGSTATUS, WGSET, WGLISTWORDS, WGDONATE, WGDEFAULTCHANNEL, WGTOP, WGPWD, WGLOGIN, WGADMIN, WGADMINHELP, WGJOIN, WGNEWGAME, WGLISTGAMES, WGGIVEWORD, WGSAVE, WGLOAD, WGSAFEQUIT, WGRESETWORD, WGAUTOSAVE, WGOVERRIDEPWD, UNKNOWN, NOCOMMAND;
